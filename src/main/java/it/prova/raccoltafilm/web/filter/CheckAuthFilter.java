...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] PROTECTED_URLS = { "/utente/", "/ExecuteDeleteRegistaServlet/",
			"PrepareDeleteRegistaServlet", "PrepareDeleteFilmServlet", "ExecuteDeleteFilmServlet" };
