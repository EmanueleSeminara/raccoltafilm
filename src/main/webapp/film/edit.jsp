			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteEditFilmServlet" class="row g-3" novalidate="novalidate">
								<input type="hidden" name="idFilm" value="${edit_film_attr.id}">
								<input type="hidden" name="idRegista" value="${edit_film_attr.regista.id}">
								...
								<div class="col-md-6">
									...
									<input type="number" class="form-control" name="minutiDurata" id="minutiDurata" placeholder="Inserire la durata" value="${edit_film_attr.minutiDurata }">
								</div>
